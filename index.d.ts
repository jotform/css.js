...
// I'm not sure the best way to implement this object but this is picked up by typescript editor and works OK
interface CssJsGlobal {
	cssjs() : CssJs
}
...
interface CssJs {
   ...
   * eliminates all css comments before parsing
	 ...
	 */
	findBySelector(cssObject: CssJs, selector: string, contains?: boolean)
	 ...
	 */
	intelligentMerge(cssObject:CssJs, newArray: CssJs, reverse?: boolean)
	 ...
	 */
	intelligentCSSPush(cssObject:CssJs, minimalObject: CssJs, reverse?: boolean)
	 ...
	 * @param {CssJs} parsedCss
	 * @param {string} prefix
	 * @returns {CssJs} string in which this css prepended
	 */
	applyNamespacing(parsedCss: CssJs | string, prefix: string) : CssJs

	/**
	 *
	 * @param {string} css the original css string to be stipped out of comments
